            ...
            <div class="md-card">
                <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                    ...
                    <div class="user_heading_content">
                        <h2 class="heading_b"><span class="uk-text-truncate" id="user_edit_uname">Nitin Sharma</span><span class="sub-heading" id="user_edit_position">Sr. Electrical Engineer</span></h2>
                    </div>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <input class="md-input" type="text" id="name" name="name" value="{{ empty($user) ? '' : $user->name }}"/>
                                    </div>
                                    <div class="uk-width-medium-1-2">
                                        <label for="position">User position</label>
                                        <input class="md-input" type="text" id="position" name="position" value="{{ empty($user) ? '' : $user->position }}"/>
                                    </div>
                                </div>
                                <div class="uk-grid">
                                        ...
                                        <div class="uk-grid uk-grid-width-1-1 uk-grid-width-large-1-2" data-uk-grid-margin>
                                            <div>
                                                <div class="uk-input-group">
                                                    ...
                                                    <label>Email</label>
                                                    <input type="text" class="md-input" name="user_edit_email" value="julia.lesch@gmail.com" />
                                                </div>
                                            </div>
                                            <div>
                                                <div class="uk-input-group">
                                                    ...
                                                    <input type="text" class="md-input" name="user_edit_phone" value="(537)480-4970x7945" />
                                                </div>
                                            </div>
                                            <div>
                                                <div class="uk-input-group">
