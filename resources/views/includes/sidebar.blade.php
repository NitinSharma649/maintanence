<aside id="sidebar_main">
    ...
    <div class="sidebar_main_header">
        <div class="sidebar_logo">
            <a href="index.html" class="sSidebar_hide"><img src="{{ asset('theme/assets/img/logo_main.png') }}" alt="" height="15" width="71"/></a>
            <a href="index.html" class="sSidebar_show"><img src="{{ asset('theme/assets/img/logo_main_small.png') }}" alt="" height="32" width="32"/></a>
        </div>
